...
- generic [active] [ref=e1]:
  - banner [ref=e2]:
    - generic [ref=e4]:
      ...
      - 'button "Current workspace: test-workspace-434605e0-3daf-4378-92c1-ce0450ddc109" [ref=e9]':
        - img [ref=e10]
        - generic [ref=e12]: test-workspace-434605e0-3daf-4378-92c1-ce0450ddc109
        - img [ref=e13]
  - main [ref=e15]:
    - main [ref=e17]:
      - generic [ref=e18]:
      ...
      - generic [ref=e24]:
        ...
        - list "Projects" [ref=e27]:
          - button "Select project Keyboard Project" [ref=e28] [cursor=pointer]:
            - generic [ref=e29]:
              - heading "Keyboard Project" [level=3] [ref=e30]
            ...
            - button "Delete project Keyboard Project" [ref=e38]:
              - img [ref=e39]
  - alert [ref=e41]
```