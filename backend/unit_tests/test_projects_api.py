...
class TestValidationEnhancements:
    ...
    def test_create_project_duplicate_after_trimming(self, client, create_sample_project):
    ...
    def test_update_project_with_leading_trailing_spaces(self, client, create_sample_project):
    ...
    def test_update_project_duplicate_after_trimming(self, client, create_sample_project):
        """Test that duplicate detection works after trimming on update."""
        project1 = create_sample_project(name="First Project")
    ...
    def test_update_project_description_max_length_valid(self, client, create_sample_project):
        ...
        response = client.put(
            f"/api/projects/{project.id}",
            json={"description": description_2000}
        )
    ...
    def test_update_project_description_max_length_exceeded(self, client, create_sample_project):
        ...
        response = client.put(
            f"/api/projects/{project.id}",
            json={"description": description_2001}
        )
    ...
    def test_update_project_empty_description_converted_to_null(self, client, create_sample_project):
    ...
    def test_database_constraint_enforcement(self, client, create_sample_project, db_session):
        """
    ...
    def test_create_project_only_whitespace_name_fails(self, client):
        """Test that a name with only whitespace (which trims to empty) fails validation."""
        response = client.post(
            "/api/projects",
            json={
        ...
        assert any("empty" in str(err).lower() or "whitespace" in str(err).lower() for err in error_detail)
    
    def test_update_project_only_whitespace_name_fails(self, client, create_sample_project):
