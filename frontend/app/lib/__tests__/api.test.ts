...
describe('API Client', () => {
  ...
  describe('createProject', () => {
    ...
    it('should throw ApiError on 400 Bad Request', async () => {
      ...
      await expect(createProject(projectData)).rejects.toThrow('Project already exists')
    })
  })
  ...
  describe('getProject', () => {
    ...
    it('should throw ApiError on 404 Not Found', async () => {
      ...
      await expect(getProject(999)).rejects.toThrow('Project with id 999 not found')
    })
  })
  ...
  describe('Error Handling', () => {
    it('should handle HTTP error without detail in response', async () => {
      ...
      await expect(getProjects()).rejects.toThrow('HTTP 500: Internal Server Error')
    })
